...
Class ControllerPlc {
	public function listarPlcCtr() {
		$tabla = "plc";
		$respuesta = ModeloPlc::listarPlcMdl($tabla);
		return $respuesta;
	}
...
list($ancho, $alto) = getimagesize($datos["imagen"]["tmp_name"]);
	...
	static public function ctrEditarPlc($id_plc) {
		$tabla = "plc";
		$respuesta = ModeloPlc::mdlEditarPlc($tabla, $id_plc);
		return $respuesta;
	}
	static public function ctrActualizarPlc($datos) {
		$tabla = "plc";
	...
	if ($datos["imagen"]["error"] == 4) {
		...
		$respuesta = ModeloPlc::mdlActualizarPlc($tabla, $datos, $rutaImagen);
		return $respuesta;
