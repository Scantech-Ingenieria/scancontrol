...
echo'<option value="'.$value["id_banda"].'">Serie: '.$value["numero_serie"].' / Material: ' .$value["material"].' / Paso: '.$value["paso"].' / Superficie: '.$value["superficie"].' / Ancho: '.$value["ancho"].' / Desc: '.$value["descripcion"].'</option>';
 ...
 ?>
  ...
  <input type="text" class="form-control" placeholder="Medidas"  name="BandasMedidas">
              ...
              <div class="form-group row">
            <label class="col-sm-2 col-form-label" id="largo">Largo Banda : </label> 
             <div class="col-sm-10">
 <input type="text" class="form-control" placeholder="Largo Banda"  name="LargoBanda">
...
echo'<option value="'.$value["id_rodamientos"].'">ID: '.$value["id_rodamientos"].' / Modelo: ' .$value["modelo"].' / Rodamiento: ' .$value["rodamiento"].' / Material: ' .$value["material"].' / Fijaciones: ' .$value["fijaciones"].'</option>';
 ...
 ?>
            ...
            <div class="col-sm-10 conteNuevaImagen">
              <input type="file" class="form-control"  id="imagenAlimentacion" name="imagenAlimentacion">
              <img src="" id="imgAlimentacion" alt="" class="thumbnail" width="200" style="display: none">
            </div>
          </div>
...
echo'<option value="'.$value["id_rodamientos"].'">ID: '.$value["id_rodamientos"].' / Modelo: ' .$value["modelo"].' / Rodamiento: ' .$value["rodamiento"].' / Material: ' .$value["material"].' / Fijaciones: ' .$value["fijaciones"].'</option>';
 ...
 ?>
            ...
            <label class="col-sm-2 col-form-label">Imagen</label>
            <div class="col-sm-10 conteNuevaImagen">
              <input type="file" class="form-control"  id="imagenAlimentacionEditar" name="imagenAlimentacion" >
              <img src="" id="imgAlimentacion" alt="" class="thumbnail" width="200" >
            </div>
          </div>
