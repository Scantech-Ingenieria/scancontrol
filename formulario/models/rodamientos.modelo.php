...
static public function listarRodamientosMdl($tabla) {
	...
	static public function mdlCrearRodamientos($tabla, $datos,$rutaImagen) {
		$sql = Conexion::conectar()->prepare("INSERT INTO $tabla() VALUES (NULL, :modelo,:rodamiento,:material,:fijaciones,:precio,:imagen)");
...
if( is_null($rutaImagen)) {
		$sql = Conexion::conectar()->prepare("UPDATE $tabla SET modelo = :modelo,rodamiento =:rodamiento,material =:material,fijaciones =:fijaciones,precio = :precio WHERE id_rodamientos = :id");
		$sql->bindParam(":modelo", $datos["modelo"], PDO::PARAM_STR);
		$sql->bindParam(":rodamiento", $datos["rodamiento"], PDO::PARAM_STR);
		$sql->bindParam(":material", $datos["material"], PDO::PARAM_STR);
		$sql->bindParam(":fijaciones", $datos["fijaciones"], PDO::PARAM_STR);
	...
	$sql = Conexion::conectar()->prepare("UPDATE $tabla SET modelo = :modelo,rodamiento =:rodamiento,material =:material,fijaciones =:fijaciones,precio = :precio,rutaImg =:rutaNueva WHERE id_rodamientos = :id");
		$sql->bindParam(":modelo", $datos["modelo"], PDO::PARAM_STR);
		$sql->bindParam(":rodamiento", $datos["rodamiento"], PDO::PARAM_STR);
		$sql->bindParam(":material", $datos["material"], PDO::PARAM_STR);
		$sql->bindParam(":fijaciones", $datos["fijaciones"], PDO::PARAM_STR);
