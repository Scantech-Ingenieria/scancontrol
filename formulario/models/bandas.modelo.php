...
static public function listarBandaMdl($tabla) {
	...
	static public function mdlCrearBanda($tabla, $datos) {

		$sql = Conexion::conectar()->prepare("INSERT INTO $tabla() VALUES (NULL, :numeroserie,:descripcion,:ancho,:material)");
	...
	static public function mdlActualizarBanda($tabla, $datos) {
