...
static public function listarAutomaticoMdl($tabla) {
	...
	static public function mdlCrearAutomatico($tabla, $datos) {

		$sql = Conexion::conectar()->prepare("INSERT INTO $tabla() VALUES (NULL, :amperaje,:marca,:tipo)");
	...
	static public function mdlActualizarAutomatico($tabla, $datos) {
