...
static public function listarVdfMdl($tabla) {
	...
	static public function mdlCrearVdf($tabla, $datos) {

		$sql = Conexion::conectar()->prepare("INSERT INTO $tabla() VALUES (NULL, :potencia,:marca)");
	...
	static public function mdlActualizarVdf($tabla, $datos) {
