...
static public function listarDescargaRegistroMdl($tabla) {
	...
	static public function mdlCrearDescarga($tabla, $datos,$rutaImagen) {
		$sql = Conexion::conectar()->prepare("INSERT INTO $tabla() VALUES (NULL,:tipo,:cantidadsprockets,:tipobandas,:bandasmedidas,:tipopaletas,:cantidadpaletas,:eje,:altura,:buffer,:tipomotor,:tipodescanso,:tipocilindro,:imagen,NULL)");
