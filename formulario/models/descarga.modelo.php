...
static public function listarDescargaMdl($tabla) {
	...
	static public function mdlCrearDescarga($tabla, $datos) {
		...
		$sql = Conexion::conectar()->prepare("INSERT INTO $tabla() VALUES (NULL,:tipo,:cantidadsprockets,:tipobandas,:bandasmedidas,:eje,:motorusillo,:motorcapacidad,:tipopaletas,:cantidadpaletas)");
